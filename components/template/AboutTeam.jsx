...
const Team = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      gender: 'male',
      bio: 'محمد سهرابی یک توسعه‌دهنده‌ی فرانت‌اند با مهارت‌های پیشرفته در طراحی واسط کاربری (UI) و تجربه کاربری (UX) است. او به تکنولوژی‌های جدید جاوااسکریپت مانند React.js و Next.js تسلط دارد و در ایجاد برنامه‌های وب تعاملی و ریسپانسیو بسیار توانمند است.',
    },
    {
      name: 'حسین یوسفی',
      role: 'مدیر پروژه',
